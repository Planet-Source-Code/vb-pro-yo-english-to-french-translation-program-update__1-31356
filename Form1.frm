...
Dim howmanyverbs As Integer      'holds how many words are verbs
Dim howmanypharses As Integer
...
Open "pharses.txt" For Input As #1   ' Open file for input.
Do While Not EOF(1)   ' Loop until end of file.
   Input #1, englishwo, frenchwo   ' Read data into two variables.
...
Loop
Close #1   ' Close file.
howmanypharses = whatnum
Open "verbs.txt" For Input As #1   ' Open file for input.
Do While Not EOF(1)   ' Loop until end of file.
   Input #1, englishwo, frenchwo   ' Read data into two variables.
englishwords(whatnum) = englishwo
frenchwords(whatnum) = frenchwo
...
Loop
Close #1   ' Close file.
howmanyverbs = whatnum - howmanypharses
Open "words.txt" For Input As #1   ' Open file for input.
Do While Not EOF(1)   ' Loop until end of file.
   Input #1, englishwo, frenchwo   ' Read data into two variables.
englishwords(whatnum) = englishwo
...
For i = 1 To howmanypharses
anystring = Replace(anystring, frenchwords(i), englishwords(i) & " ")
Next i
For i = howmanypharses To howmanyverbs
anystring = Replace(anystring, frenchwords(i), englishwords(i) & " ")
Next i
For i = 1 To 1000
